...
if __name__ == '__main__':
    ...
    try:
        ...
        weights_stage1['mode'] = 0.001  # 낮은 가중치로 Shock 방지
        ...
        best_params_s1 = model.optimize(opt_config, weights_stage1, 
                                        ...
                                        use_mass_constraint=True, 
                                        mass_tolerance=0.05,
                                        max_iterations=200,    # Stage 1 반복횟수
                                        use_early_stopping=True, 
        ...
        weights_stage2['mode'] = 0.5   # MAC 가중치 크게 상향
        ...
        model.optimize(opt_config_stage2, weights_stage2, 
                       ...
                       use_mass_constraint=True, 
                       mass_tolerance=0.05,
                       max_iterations=100,    # Fine-tuning은 짧게
                       use_early_stopping=True, 
